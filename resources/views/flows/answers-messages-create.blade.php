...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <form id="frm-edit-message" method="POST" action="/flows-answers-messages">
                    {{ csrf_field() }}
                    <div class="box-body pad">
                        <div class="form-group">
                            <select name="answer_id" class="form-control" required>
                                ...
                                ?>
                                <option value="<?php echo $item->id; ?>"><?php echo $item->answer_title; ?></option>
                                <?php
                                }
                                ?>
                            </select>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="message_method" placeholder="A function to generate text(usually leave it blank)" />
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" name="message_order" placeholder="Message order (if an answer has several messages)" />
                        </div>
                    </div>
