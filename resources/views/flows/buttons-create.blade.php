...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <form method="POST" action="/flows-buttons">
                    {{ csrf_field() }}
                    <div class="box-body pad">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="button_text" placeholder="Button caption" required />
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" name="button_order" placeholder="Button order (if a message has several buttons)" />
                        </div>
                    </div>
